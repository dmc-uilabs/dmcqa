	...
	public static void myProfile(WebDriver driver, WebDriverWait wait){
		...
		//driver.findElement(By.xpath("/html/body/div[6]/md-menu-content/md-menu-item[2]/a/span")).click();
			...
			//Location 
			 ...
			 driver.findElement(By.xpath("//*[@id='tab-content-99']/div/md-content/div/form/button/span")).click();//add
			 ...
			 driver.findElement(By.xpath("//*[@id='documentDropZone']/div/div/ng-md-icon/svg")).sendKeys("UI_LABS_3.jpg");//document drop 
			 
			 //UI_LABS_3.jpg
			 //driver.findElement(By.id("profile_pic_10")).sendKeys("C:\\Users\\Anupam\\Desktop\\aaa.png");
			 //driver.findElement(By.xpath("/html/body/div[2]/div/md-content/div/div[2]/div[2]/button[2]/span")).click();
